...
{
	private static int START_SCALED_VALUE = 10;
	private static int START_MOVING_VALUE = 5;
	private static int MAX_SCALED_VALUE = 20;
	private static int MAX_MOVING_VALUE = 15;
	...
	private MenuController()
	{
		try 
		{
			window = new StandartGraphWindow("Лабораторная работа №1", new BarsCreator(this), START_SCALED_VALUE, START_MOVING_VALUE, this);
		} 
		catch (Exception e) 
		{
	...
	/**
	 * Draws x-axis and y-axis on main window of this program.
	 */
	public void drawCoordinateLines()
	{
		...
		contr.drawCoordinateLines(picture, DEFAUTL_TENSION * length, position);
